...
BLOG_AUTHOR = "Vector Linux"  # (translatable)
BLOG_TITLE = "Vector Linux"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link
SITE_URL = "http://vectorlinux.com"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://vectorlinux.com"
BLOG_EMAIL = "info@vectorlinux.com"
BLOG_DESCRIPTION = "Vector Linux home page"  # (translatable)
